...
- [ ] **Phase 3** — 商品詳細・カートUX・補助ページ（進行中: 2026-05-07 着手）
  ...
  - [ ] 3f 補助ページ（お届けについて 完了 / FAQ・特定商取引法・店舗情報 残）
  - [ ] 3g アレルゲン構造化データ（任意）
- [ ] **Phase 4** — レスポンシブ調整・Lighthouse 計測・ドキュメント整備・公開準備

各フェーズのスクリーンショット差分は [`docs/screenshots/`](./docs/screenshots/) で `baseline → phase-1 → phase-2` の順に確認できます。
